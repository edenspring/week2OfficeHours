...
that advance thataccepts an array and a callback and returns a new array.
This new array should hold the results of passing each element through the
callback.

const arr1 = [1,2,3,4]
const doubler = (num) => return num * 2
console.log(advance(arr1, doubler)) // [2,4,6,8]

const arr2 = ["Hi", "there", "let's", "use", "strings"]
const angryGoose = (word) return word + " " + "HONK!"
